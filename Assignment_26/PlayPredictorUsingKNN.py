...
BORDER="-"*50
"""---------------------------------------------------------------------------------
#  This method loads the data set from 'PlayPredictor.csv' file
#  Input params : Data file path
#  Output : Data frame
#---------------------------------------------------------------------------------"""
def loadDataSet(dataFilePath):
    #Read csv file
    dfPlayPredictor=pd.read_csv(dataFilePath)
...
# Input params: dFPlay(Play data frame)
# Creating encoded csv file for refernce with name 'PlayPredictorEncoded.csv' 
#---------------------------------------------------------------------------------"""
...
def getIndepedentAndDependentCol(dFPlay):
    xIndependent=dFPlay.drop(columns=['Play'])
    yDependent=dFPlay['Play']
    return xIndependent,yDependent
"""---------------------------------------------------------------------------------------------------------
#  This method predicts the result
...
"""---------------------------------------------------------------------------------------------------------  
# This method decodes the predicted result values
...
def main():
    ...
    dFPlay=loadDataSet("PlayPredictor.csv")
