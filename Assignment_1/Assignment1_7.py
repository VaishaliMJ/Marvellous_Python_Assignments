...
Problem statement :
            ...
            checks if given number is divisible by 5   
Learnings:---> Use of % operator and divisible by 5 logic
          ---> Returning function value as 'boolean' 

Built-in function used :input()
                    
Function Used: isDivisibleByFive(num):
                        : Input : Integer number
                        : Output : prints on console(True/False) if given number is divisible by 5
------------------------------------------------------------------------------------------"""
#------------------------------------------------------------------
# This function checks if input number 'num' is divisible by 5 or not
# If divisible by 5 returns 'True' 
# else 'False'    
